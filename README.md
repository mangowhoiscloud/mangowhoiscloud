...
| 축 | 역할 | 실천 사례 |
|---|---|---|
| **컨텍스트 제어** | 루프와 가드레일이 출력의 상한을 결정 | GEODE/REODE 5-Layer Context Hub(C0-C4, 글로벌과 로컬 .geode/.reode), Runtime PromptAssembler 6-Phase, Model Switching Context Compression, SHA-256 pinning |
