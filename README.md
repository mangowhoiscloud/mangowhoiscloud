...
LangGraph Multi-Agent 하네스를 구축하고, 계측 근거로 아키텍처를 네 차례 전환해 LLMx2 DAG **VU 1,000 / 97.8%** 도달. 관측 지표: LLMx2 DAG **TPM 400M**. Cluster-baseline(ext-authz) Auth Offloading **48 → 1,477 RPS**. Swiss Cheese 3-Layer 평가에서 **69.4 → 99.8/100**.
