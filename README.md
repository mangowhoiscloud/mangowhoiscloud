...
| 축 | 역할 | 실천 사례 |
|---|---|---|
| **컨텍스트 제어** | 입력의 정밀도가 출력의 상한을 결정 | GEODE/REODE 5-Layer Context Hub(C0-C4, 글로벌과 로컬 .geode/.reode), Runtime PromptAssembler 6-Phase, Model Switching Context Compression, SHA-256 pinning(비용 40-60% 절감) |
